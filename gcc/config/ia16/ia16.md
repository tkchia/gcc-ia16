...
; Complex modes except CQI, which needs special treatment.
...
(define_insn_and_split "*seqsi_<USE_Z:mode>"
  ...
  "#"
  "reload_completed"
  [(parallel [(set (reg:HI D_REG) (eq:HI (reg:USE_Z CC_REG) (const_int 0)))
...
(define_expand "parityhi2"
  [(set (match_dup 2) (match_operand:HI 1 "general_operand"))
   (parallel [(set (reg:CC CC_REG)
		   (compare:CC (xor:HI (and:HI (match_dup 2) (const_int -256))
...
(define_insn "*parityhi2"
  [(set (match_operand:HI 0 "register_operand" "=a,r")
	(parity:HI (reg:CC CC_REG)))
   (clobber (match_operand:HI 1 "nonimmediate_operand" "=X,a"))
   (clobber (reg:CC CC_REG))]
  ""
  "@
   lahf\;andb\t$0x4,\t%H0\;addb\t$0xfc,\t%H0\;sbbw\t%0,\t%0\;incw\t%0
   lahf\;andb\t$0x4,\t%H1\;addb\t$0xfc,\t%H1\;sbbw\t%0,\t%0\;incw\t%0"
)
...
(define_insn "*b<code>_<mode>"
  [(set (pc) (if_then_else (any_cond_z (reg:USE_Z CC_REG)
				       (const_int 0))
			   (label_ref (match_operand 0))
	                   (pc)))]
  ""
...
(define_insn "*b<code>_<mode>"
  [(set (pc) (if_then_else (any_cond_cz (reg:USE_CZ CC_REG)
					(const_int 0))
			   (label_ref (match_operand 0))
			   (pc)))]
  ""
...
(define_insn "*b<code>_<mode>"
  [(set (pc) (if_then_else (any_cond_so (reg:USE_SO CC_REG)
					(const_int 0))
			   (label_ref (match_operand 0))
			   (pc)))]
  ""
...
(define_insn "*b<code>_<mode>"
  [(set (pc) (if_then_else (any_cond_soz (reg:USE_SOZ CC_REG)
					 (const_int 0))
			   (label_ref (match_operand 0))
			   (pc)))]
  ""
...
(define_insn "*blt_<mode>"
  [(set (pc) (if_then_else (lt (reg:USE_S CC_REG) (const_int 0))
			   (label_ref (match_operand 0))
			   (pc)))]
  ""
  "js\t%l0"
...
(define_insn "*bge_<mode>"
  [(set (pc) (if_then_else (ge (reg:USE_S CC_REG) (const_int 0))
			   (label_ref (match_operand 0))
			   (pc)))]
  ""
  "jns\t%l0"
...
(define_insn "*b<code>_<mode>_rev"
  [(set (pc)
	(if_then_else (any_cond_z (reg:USE_Z CC_REG) (const_int 0))
		      (pc)
		      (label_ref (match_operand 0))))]
  ""
  "<mnemonic_rev>\t%l0"
...
(define_insn "*b<code>_<mode>_rev"
  [(set (pc)
	(if_then_else (any_cond_cz (reg:USE_CZ CC_REG) (const_int 0))
		      (pc)
		      (label_ref (match_operand 0))))]
  ""
  "<mnemonic_rev>\t%l0"
...
(define_insn "*b<code>_<mode>_rev"
  [(set (pc)
	(if_then_else (any_cond_so (reg:USE_SO CC_REG) (const_int 0))
		      (pc)
		      (label_ref (match_operand 0))))]
  ""
  "<mnemonic_rev>\t%l0"
...
(define_insn "*b<code>_<mode>_rev"
  [(set (pc)
	(if_then_else (any_cond_soz (reg:USE_SOZ CC_REG) (const_int 0))
		      (pc)
		      (label_ref (match_operand 0))))]
  ""
  "<mnemonic_rev>\t%l0"
